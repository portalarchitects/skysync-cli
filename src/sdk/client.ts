...
export class SkySyncClient {
	...
	get extractors(): ExtractorResource {
		return new ExtractorResource(this._httpClient);
	}

	get suggestors(): SuggestorResource {
		return new SuggestorResource(this._httpClient);
	}
}
